...
This directory preserves dated verification results and implementation records that no longer describe the current release or source tree. Archive pages are evidence for the version, commit, client, and date that they name. They are not current product reference.
...
| [Contract corrections from 2026-07-07 through 2026-08-19](contract-corrections-2026-07-07-to-2026-08-19.md) | Superseded consent and issuer wording, including why each correction was required. |
| [Contract development history from 2026-07 through 2026-08](contract-development-history-2026-07-to-2026-08.md) | Draft reviews, CIMD verification context, upstream-flow audience rationale, and the ID-JAG adjacency record. |

Current documentation starts at the [documentation index](../README.md).
