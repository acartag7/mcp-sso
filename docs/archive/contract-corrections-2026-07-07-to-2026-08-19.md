...
The current rules are in the [contract index](../contracts.md): consent approval and the malformed consent cookie in [§9 the bridge contract](../contracts/09-as-lite-bridge-contract.md), and the issuer spelling in [§5 the configuration contract](../contracts/05-configuration-contract.md). Current documentation starts at the [documentation index](../README.md).
