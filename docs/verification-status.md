...
That campaign does not prove the current source tree. The source has changed since `d6143b3`. CI covers the later stored-registration outage behavior, but no live campaign covers the current head.
