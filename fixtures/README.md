...
Token-admission work adds 65 draft fixtures: 59 portable and six host, naming §7.2 and §8.1. They cover signature, issuer, audience-mismatch, expiry, subject, and credential-marker input classes. Drafts are not evidence. The receipts in §7 and §8 record direct clock, verifier-result, and header-boundary observations separately. Exact audience-shape coverage remains incomplete; no complete first-slice or published corpus claim follows from these drafts.
