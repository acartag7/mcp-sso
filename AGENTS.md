...
- **Self-hosted workflows:** main and the named migration bootstrap branch run
  automatically. For any other feature branch, review its workflow diff first,
  then dispatch CI and CodeQL against that exact ref.
