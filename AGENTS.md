...
- **Spec target:** **MCP Authorization `2025-11-25`**. The official stable
  ...
  native-app precondition on the loopback port exception), plus one unresolved
  test-evidence row. See the matrix in [`docs/contracts/16-spec-conformance-matrix.md`](docs/contracts/16-spec-conformance-matrix.md#161-cimd-draft--00-requirement-matrix)
