...
// exchange, and direct identity verification (contracts §6.7, fix #7). Bridge
// checks register:<ip>, token:<ip>, or authorize:<ip> before the corresponding
// work and returns 429 on false. The no-op default allows everything; a THROWN
// error is fail-open (allow) — rate-limiting is defense-in-depth against flooding
