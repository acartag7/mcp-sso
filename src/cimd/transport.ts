 ...
 *  cache-relevant header occurrences only — never the full header map. The
 *  explicit validity bit keeps malformed runtime values distinct from absent
 *  fields, so every malformed relevant header fails toward re-fetch. */
