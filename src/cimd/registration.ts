 ...
 *  matching when application_type is native or absent. Explicit web remains
 *  exact. Scheme, host, path, and search stay equal while only the port is
 *  ignored. Called at authorize, at the callback row-5a gate, and at
